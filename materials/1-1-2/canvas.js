...
function initQuizSystem() {
  ...
  const answers = {
    '1-2-1-1': 'A', // Q1. (-9)+(-7) = -16
    '1-2-1-2': 'B', // Q2. (-12)+7 = -5
    '1-2-2-1': 'A', // Q3. (-23)+1205+(-77) = 1105
    '1-2-2-2': 'D', // Q4. 132+(-59)+(-132) = -59
    '1-2-3-1': 'A', // Q5. 125-(-25) = 150
    '1-2-3-2': 'D', // Q6. (-63)-37 = -100
    '1-2-4-1': 'C', // Q7. 299-(396+299) = -396
    '1-2-4-2': 'C', // Q8. -(a-b) = -a+b = b-a
    '1-2-5-1': 'B', // Q9. |-25|-|-75|-18 = -68
    '1-2-5-2': 'C', // Q10. 30+|(-64)+14|-25 = 55
    '1-2-6-1': 'D', // Q11. CD distance = 5

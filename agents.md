...
- [ ] 階段八：其餘佔位頁逐節建置（已完成 `1-1-4`「指數記法與科學記號」復古太空探險風、`1-2-1`「因數與倍數」台灣夜市水彩風、`1-2-2`「最大公因數與最小公倍數」8-bit 像素電玩風，皆為 6 重點／6 互動／12 題）
- [x] 階段九：投影可讀性與窄螢幕版面修正——MathJax 上下標與數字字距（`1-1-4`）、CSS Grid／flex 溢出裁切（`1-1-1`～`1-1-4` 與首頁）；規則已收進〈開發約束〉9～11

> 目前課程進度：58 節中 `1-1-1`、`1-1-2`、`1-1-3`、`1-1-4`、`1-2-1`、`1-2-2` 完成，其餘 52 節為佔位頁。
